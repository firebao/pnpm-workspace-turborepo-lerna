<!--消息订阅-->
<template>
  <div class="platform-menu-toggle-drawer" style="font-size: 40px;">
    <transition name="drawer">
      <div v-if="drawerOpen" class="drawer-container">
        <div class="left-drawer-btn" style="background-color: #fff;" @click="toggleDrawer">
                  ...
                  <el-row :gutter="16">
                    <el-col :span="4">
                      <el-form-item label="层级">
                        <el-select v-model="form.layerId" placeholder="请选择" class="platform-select" size="small" clearable @change="handleLayerSelect(form)">
                          <el-option
                    ...
                    <el-col :span="4">
                      <el-form-item label="专业">
                        <treeselect @input="handleMajorSelect(form)" style="height: 30px;width: 160px;" v-model="form.majorId"
                    ...
                    <el-col :span="4">
                      <el-form-item label="系统">
                        <el-select v-model="form.systemId" placeholder="请选择" size="small" clearable @change="handleSystemSelect(form)">
                          <el-option
                    ...
                    <el-col :span="4">
                      <el-form-item label="订阅状态">
                        <el-select v-model="form.subscriptionStatus" placeholder="请选择" class="platform-select" size="small" clearable @change="handleStateSelect(form)">
                          <el-option
                    ...
                    <el-col :span="4" style="line-height: 0.375rem;">
                      <el-button size="small" style="background: $primary-color;" type="primary" @click="handleSearch">搜索</el-button>
                ...
                <div class="platform-search-card-content">
                  <div v-for="(item,index) in messageComponentsData" :key="index"
                    ...
                    <div class="platform-search-card-item-top" style="margin-top: 10px;">
                      ...
                      <div v-if="item.subscriptionStatus === '1'" class="platform-search-card-top-title-icon-add"><span>已订阅</span></div>
                      ...
                      <el-row :gutter="4">
                        ...
                        <el-col :span="22">
                          <div class="platform-menu-card-label">
                            ...
                            <span class="platform-personal-panel-report-name-content">{{ item.sourceSummary.substring(0,40) }}</span>
                    ...
                    <div class="platform-content-card-button">
                      ...
                      <el-button v-if="item.subscriptionStatus === '0'" class="platform-content-card-button-Add" type="text" @click="handleSubscribe(item)">立即订阅
                      </el-button>
                      <el-button v-else class="platform-content-card-button-Remove" type="text" @click="deleteUserSubscription(item)">取消订阅</el-button>
                    </div>
                  </div>
              ...
              <el-row :gutter="4">
                ...
                <el-col :span="4" style="text-align: left;margin-bottom: 10px;">
                  <div style="line-height: 0;">
                    <el-button size="mimi" style="background: $primary-color;" type="primary" @click="subscribeAll">全部订阅</el-button>
    ...
    <!--查看详情-->
    <details-dialog :addOrUpdateVisible="addOrUpdateVisible" @changeShow="showAddOrUpdate" ref="detailsDialogRef"></details-dialog>
  </div>
</template>
  ...
  methods: {
    ...
    // 查询系统列表
     getSearchSystemList(val) {
       ...
       searchSystemList(params).then((res) => {
        if (res.status === 200) {
