  ...
  <div class="platform-menu-toggle-drawer">
    <transition name="drawer">
      <div v-if="drawerOpen" class="drawer-container">
        ...
        <!-- 抽屉内容 -->
        <menu-system-select @get-drawer-type="getDrawerType " @get-drawer-status="getDrawerStatus"></menu-system-select>
      </div>
    </transition>
  </div>
</template>
...
<script>
import menuSystemSelect from "@/views/components/myMenu/addSystemMenu/menuDrawerContent/menuSystemSelect";
